...
export class ArticleForm {
    ...
    addTag(tagInput: HTMLInputElement) {
        ...
        this.form.controls.tagList.patchValue([...this.form.controls.tagList.value, trimmed]);

        tagInput.value = '';
    }

    removeTag(tagToRemove: string) {
        this.form.controls.tagList.patchValue(this.form.controls.tagList.value.filter((tag) => tag !== tagToRemove));
    }
}
