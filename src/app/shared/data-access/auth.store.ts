...
import { Profile, ProfileApiClient, User, UserAndAuthenticationApiClient } from './api';
...
export class AuthStore extends ComponentStore<AuthState> {
    ...
    readonly username$ = this.select(this.user$.pipe(filter((user): user is User => !!user)), (user) => user.username);
