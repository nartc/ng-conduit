...
describe(AuthStore.name, () => {
    ...
    async function setup() {
        mockedApiClient = jasmine.createSpyObj<ApiClient>(ApiClient.name, ['getCurrentUser', 'getProfileByUsername']);
        mockedLocalStorageService = jasmine.createSpyObj<LocalStorageService>(LocalStorageService.name, [
            'setItem',
            'removeItem',
            'getItem',
        ]);
    ...
    describe('Given not logged in', () => {
        describe('When init', () => {
            ...
            it('Then call localStorage.getItem', async () => {
                ...
                expect(mockedLocalStorageService.getItem).toHaveBeenCalledWith('ng-conduit-token');
            });
    ...
    describe('Given logged in', () => {
        ...
        function arrange() {
            mockedLocalStorageService.getItem.withArgs('ng-conduit-token').and.returnValue(currentUser.token);
        ...
        describe('When init', () => {
            ...
            it('Then call apiClient.getProfileByUsername', async () => {
                ...
                expect(mockedApiClient.getProfileByUsername).toHaveBeenCalledWith(currentUser.username);
            });
            ...
            it('Then call localStorage.setItem with currentUser', async () => {
                ...
                expect(mockedLocalStorageService.setItem).toHaveBeenCalledWith('ng-conduit-user', currentUser);
            });
