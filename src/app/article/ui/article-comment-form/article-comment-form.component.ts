    ...
    template: `
        <form [formGroup]="form" class="card comment-form" (ngSubmit)="submit()">
            ...
            <div class="card-footer">
                <img [src]="currentUser.image" alt="Avatar of current user" class="comment-author-img" />
...
export class ArticleCommentForm {
    ...
    readonly form: TypedFormGroup<{ comment: string }> = inject(FormBuilder).nonNullable.group({
        comment: [''],
    });
