...
describe(Register.name, () => {
    ...
    async function setup(registerErrors: string[] = []) {
        ...
        mockedStore = jasmine.createSpyObj<RegisterStore>(RegisterStore.name, ['register'], {
    ...
    describe('When submit form', () => {
        it('Then calls store.register with form value', async () => {
            ...
            expect(mockedStore.register).toHaveBeenCalledWith(fixture.componentInstance.form.getRawValue());
        });
    });
});
